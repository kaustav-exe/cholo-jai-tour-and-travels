...
import { siteConfig, aboutData } from '../src/data/siteConfig';
import { facebookReels } from '../src/data/facebookReels';
import { galleryImages } from '../src/data/gallery';

async function generateAndMigrate() {
  console.log('📦 Extracting all existing website content...');
  ...
  console.log(`✅ Generated ${documents.length} structured Sanity documents in ${ndjsonPath}`);
